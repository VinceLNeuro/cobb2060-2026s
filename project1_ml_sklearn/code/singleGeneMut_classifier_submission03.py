...
ref_hugo_entrez = ref_hugo_entrez.dropna(subset=['Entrez_Gene_Id'])
...
# Normalize if needed
test_expr = log2cpm_for_counts(test_expr)
...
for gene in target_genes:
    ...
    # Impute (to ensure no NaNs) + Scale
