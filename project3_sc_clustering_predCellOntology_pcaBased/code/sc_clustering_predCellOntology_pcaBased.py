...
if args.train_data is not None:
    ...
    # Use PCA to further reduce dimension
    sc.tl.pca(combined, n_comps=50, random_state=RANDOM_STATE)
    X = combined.obsm['X_pca']
    print(f'Combined PCA shape: {X.shape}')
    ...
    # Predict
    I = clf.predict(X_test_umap)
    print(Counter(I))
    print(Counter(le.inverse_transform(I)))
