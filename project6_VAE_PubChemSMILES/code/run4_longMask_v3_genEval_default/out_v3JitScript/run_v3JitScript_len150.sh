#!/bin/bash
#SBATCH --job-name=run_v3JitScript_len150__defaultVAE
...
####################    This run    ####################
# total 5M  -> train 4.75M   -> per epoch batches = 9277  -> (10 epochs) total steps = 92770
#           -> val 250k      -> 488 batches
...
# Larger Mod
#   -> word_dropout_rate lower for longer sequence;  kl_max_weight higher for novelty
python train_VAE_v3JitScript.py \
        -T /net/dali/home/mscbio/til177/Github/cobb2060-2026s/project6_VAE_PubChemSMILES/data/pubchem_randomized_len150_Mol5M.npy \
        --out /net/dali/home/mscbio/til177/Github/cobb2060-2026s/project6_VAE_PubChemSMILES/code/run4_longMask_v3_genEval_default/out_v3JitScript/vae_decoder_len150_Mol5M_defaultVAE_JitScript.pth \
        --max_length 150 \
        --bidirectional \
        --epochs 10  --batch_size 512 \
        --word_dropout_rate 0.3  --kl_max_weight 0.02 \
        --log_every 1000  --val_every 3000  --val_batches 200 \
        --gen_eval_samples 300
